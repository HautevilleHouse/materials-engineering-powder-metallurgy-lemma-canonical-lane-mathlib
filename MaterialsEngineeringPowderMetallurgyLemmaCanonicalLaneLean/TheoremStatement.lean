import HautevilleHouse.MaterialsEngineeringPowderMetallurgyLemmaCanonicalLaneLean.ReviewerBridge
import HautevilleHouse.MaterialsEngineeringPowderMetallurgyLemmaCanonicalLaneLean.MathlibObjects
...
def sourceRepository : String :=
  "materials-engineering-powder-metallurgy-lemma-canonical-lane"

def sourceDescription : String :=
  "Powder Metallurgy Lemma"

structure SourceTheoremBoundary where
  claimBoundary : String

def sourceTheoremBoundary : SourceTheoremBoundary :=
  { claimBoundary := "classical boundary: unrestricted classical closure remains carried" }
